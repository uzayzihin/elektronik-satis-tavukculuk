      ...
      <div className="container-x relative py-8 md:py-12 lg:py-14">
        <div className="max-w-3xl mx-auto text-center flex flex-col items-center">
          ...
          <a
            ...
            className="group relative w-full max-w-xl inline-flex items-center justify-between gap-3 overflow-hidden rounded-md bg-brand-dark text-white font-bold pl-7 pr-5 py-3 uppercase tracking-wider transition-all hover:scale-[1.01] shadow-xl shadow-black/20"
          >
            <span
              aria-hidden="true"
