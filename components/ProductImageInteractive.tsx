      ...
      <AnimatePresence>
        {isOpen && (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            >
              <div className="p-6 text-center border-b border-brand-light relative">
                ...
                <button 
                  onClick={() => setIsOpen(false)}
                  className="absolute top-6 right-6 text-brand-muted hover:text-brand-accent transition-colors"
                >
                  <X className="w-6 h-6" />
                </button>
              </div>
              ...
              <div className="p-6 grid grid-cols-2 gap-4">
                <button
                  ...
                  className={`flex flex-col items-center gap-4 p-6 rounded-xl border-2 transition-all ${
                    currentPackaging === "tabakli" 
                      ? "border-brand-primary bg-brand-soft/20 shadow-md scale-105" 
                      : "border-brand-light hover:border-brand-accent hover:shadow-lg"
                  }`}
                >
                  <div className={`w-16 h-16 rounded-full flex items-center justify-center ${
                    currentPackaging === "tabakli" ? "bg-brand-primary text-white" : "bg-brand-light text-brand-navy"
                  }`}>
                ...
                >
                  <div className={`w-16 h-16 rounded-full flex items-center justify-center ${
                    currentPackaging === "dokme" ? "bg-brand-primary text-white" : "bg-brand-light text-brand-navy"
                  }`}>
